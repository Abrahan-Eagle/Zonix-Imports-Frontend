...
# Script para ejecutar Flutter solo en dispositivos Android
# ZONIX-Imports Frontend - Solo Android

echo "🚀 ZONIX-Imports - Ejecutando en Android"
echo "========================================"
...
if adb devices | grep -q "$DEVICE_IP"; then
    ...
    echo ""
    echo "🚀 Ejecutando aplicación Flutter en Android..."
    
    # Ejecutar Flutter en el dispositivo Android
    flutter run -d $DEVICE_IP
else
