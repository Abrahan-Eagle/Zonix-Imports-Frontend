...
import 'package:zonix/features/GasTicket/gas_button/screens/gas_ticket_list_screen.dart';
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                if (_selectedLevel == 0) {
                  ...
                  if (_bottomNavIndex == 2 && role == 'sales_admin')
                    return const TicketScannerScreen();
                  if (_bottomNavIndex == 3 && role == 'sales_admin')
                    return const CheckScannerScreen();
                  if (_bottomNavIndex == 2 && role == 'dispatcher')
