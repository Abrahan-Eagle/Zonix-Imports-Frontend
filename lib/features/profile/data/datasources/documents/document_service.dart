...
import 'package:zonix/features/profile/data/datasources/addresses/adresse_service.dart';
...
class DocumentService {
  ...
  Future<List<Document>> fetchDocuments(int id) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        logger.i(
            'Documents fetched successfully: ${jsonResponse.length} documents found.');
  ...
  Future<void> createDocument(
    ...
    try {
      ...
      request.fields['expires_at'] =
          document.expiresAt?.toIso8601String() ?? '';
      ...
      if (response.statusCode == 201) {
        ...
        logger.e(
            'Error creating document: ${response.statusCode} - $responseBody');
  ...
  Future<void> updateDocument(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final responseBody = await response.stream.bytesToString();
        logger.e(
            'Error updating document: ${response.statusCode} - $responseBody');
