      ...
      setState(() {
        if (_profile != null) {
          _profile = _profile!.copyWith(
              dateOfBirth: savedDate); // Guardar en formato adecuado para la DB
        }
      });
    }
  }
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        await ProfileService().updateProfile(
            _profile!.id, _profile!.copyWith(dateOfBirth: formattedDateOfBirth),
                  ...
                  child: AspectRatio(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.circular(
                          10.0), // Asegura que las esquinas de la imagen coincidan
                      child: Image.file(
                        _imageFile!,
