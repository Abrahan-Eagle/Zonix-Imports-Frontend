...
class DocumentDetailScreen extends StatelessWidget {
  ...
  Widget _buildDocumentSpecificInfo(BuildContext context) {
    ...
    switch (document.type) {
      case 'ci':
        return _buildInfoRow('Cédula de Identidad',
            'Documento Nacional de Identidad', Icons.badge);
      case 'passport':
        return _buildInfoRow('Pasaporte', 'Documento de Viaje Internacional',
            Icons.flight_takeoff);
      case 'rif':
        return _buildInfoRow(
            'RIF', 'Registro de Información Fiscal', Icons.business);
      case 'neighborhood_association':
        return _buildInfoRow(
            'Asociación de Vecinos', 'Documento Comunitario', Icons.people);
      default:
        return _buildInfoRow(
            'Documento', 'Tipo no especificado', Icons.description);
    }
  }
