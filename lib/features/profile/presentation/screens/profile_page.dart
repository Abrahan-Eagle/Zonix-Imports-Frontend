...
import 'package:zonix/features/profile/presentation/screens/edit_profile_page.dart';
import 'package:zonix/features/profile/presentation/screens/create_profile_page.dart';
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            _buildInfoRow(
                context, 'Nombre', profile.firstName ?? 'N/A', Icons.person_outline),
            if (profile.middleName != null && profile.middleName!.isNotEmpty)
              _buildInfoRow(context, 'Segundo Nombre', profile.middleName!,
                  Icons.person_outline),
            _buildInfoRow(
                context, 'Apellido', profile.lastName ?? 'N/A', Icons.person_outline),
            ...
            _buildInfoRow(
                ...
                Icons.favorite),
            _buildInfoRow(
                context, 'Sexo', _translateSex(profile.sex ?? 'N/A'), Icons.wc),
          ],
        ),
      ),
    );
