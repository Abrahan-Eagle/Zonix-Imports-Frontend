...
class SearchService {
  ...
  Future<List<Map<String, dynamic>>> searchRestaurants({
    ...
    try {
      ...
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/search/restaurants')
  ...
  Future<List<Map<String, dynamic>>> searchProducts({
    ...
    try {
      ...
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/search/products')
          .replace(queryParameters: queryParams);
  ...
  Future<List<Map<String, dynamic>>> getCategories({
    ...
    try {
      ...
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/search/categories')
          .replace(queryParameters: queryParams);
  ...
  Future<List<String>> getSearchSuggestions({
    ...
    try {
      ...
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/search/suggestions')
          .replace(queryParameters: queryParams);
