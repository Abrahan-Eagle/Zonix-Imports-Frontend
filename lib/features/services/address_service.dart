...
class AddressService {
  ...
  Future<List<Map<String, dynamic>>> getUserAddresses() async {
    try {
      ...
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/addresses');
  ...
  Future<Map<String, dynamic>> updateAddress(int addressId, Map<String, dynamic> addressData) async {
    try {
      final headers = await AuthHelper.getAuthHeaders();
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/addresses/$addressId');
  ...
  Future<bool> setDefaultAddress(int addressId) async {
    try {
      final headers = await AuthHelper.getAuthHeaders();
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/addresses/$addressId/default');
  ...
  Future<Map<String, dynamic>?> getDefaultAddress() async {
    try {
      final headers = await AuthHelper.getAuthHeaders();
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/addresses/default');
