...
class BuyerPaymentService {
  ...
  Future<List<Map<String, dynamic>>> getPaymentMethods() async {
    try {
      ...
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/payments/methods');
  ...
  Future<Map<String, dynamic>> processCardPayment(Map<String, dynamic> paymentData) async {
    try {
      final headers = await AuthHelper.getAuthHeaders();
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/payments/card');
  ...
  Future<Map<String, dynamic>> confirmCashPayment(Map<String, dynamic> paymentData) async {
    try {
      final headers = await AuthHelper.getAuthHeaders();
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/payments/cash');
  ...
  Future<Map<String, dynamic>> processMobilePayment(Map<String, dynamic> paymentData) async {
    try {
      final headers = await AuthHelper.getAuthHeaders();
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/payments/mobile');
  ...
  Future<Map<String, dynamic>> getPaymentReceipt(int orderId) async {
    try {
      final headers = await AuthHelper.getAuthHeaders();
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/payments/receipt/$orderId');
  ...
  Future<Map<String, dynamic>> processPayPalPayment(Map<String, dynamic> paymentData) async {
    try {
      final headers = await AuthHelper.getAuthHeaders();
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/payments/paypal');
      final response = await http.post(
        url,
        headers: headers,
        body: jsonEncode(paymentData),
  ...
  Future<Map<String, dynamic>> processMercadoPagoPayment(Map<String, dynamic> paymentData) async {
    try {
      final headers = await AuthHelper.getAuthHeaders();
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/payments/mercadopago');
      final response = await http.post(
        url,
        headers: headers,
        body: jsonEncode(paymentData),
  ...
  Future<Map<String, dynamic>> requestRefund(Map<String, dynamic> refundData) async {
    try {
      final headers = await AuthHelper.getAuthHeaders();
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/payments/refund');
      final response = await http.post(
        url,
        headers: headers,
  ...
  Future<List<Map<String, dynamic>>> getPaymentHistory() async {
    try {
      final headers = await AuthHelper.getAuthHeaders();
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/payments/history');
      final response = await http.get(url, headers: headers);
      if (response.statusCode == 200) {
        final data = jsonDecode(response.body);
        if (data['success'] == true && data['data'] != null) {
  ...
  Future<Map<String, dynamic>> getPaymentStatistics() async {
    try {
      final headers = await AuthHelper.getAuthHeaders();
      final url = Uri.parse('${EnvHelper.apiUrl}/api/buyer/payments/statistics');
      final response = await http.get(url, headers: headers);
      if (response.statusCode == 200) {
        final data = jsonDecode(response.body);
        if (data['success'] == true && data['data'] != null) {
