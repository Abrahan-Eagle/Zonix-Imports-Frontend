...
class _OnboardingPage4State extends State<OnboardingPage4> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Icono de encargo especial
          _buildSpecialOrderIcon(),
          ...
          // Características de encargos
          _buildSpecialOrderFeatures(),
          const SizedBox(height: 40),
  ...
  Widget _buildSubtitle() {
    ...
    return Text(
      '¿Algo que no ves en el catálogo? Lo pedimos por encargo directamente a fábrica.',
      textAlign: TextAlign.center,
      style: TextStyle(
        fontSize: responsiveFontSize,
  ...
  Widget _buildSpecialOrderFeatures() {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceEvenly,
      children: [
        _buildFeatureItem(Icons.search_off, 'No está'),
        _buildFeatureItem(Icons.factory, 'Directo'),
        _buildFeatureItem(Icons.check_circle, 'Garantizado'),
      ],
    );
  }
  ...
  Widget _buildStats() {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          _buildStatItem('24h', 'Cotización'),
          _buildStatItem('7d', 'Producción'),
          _buildStatItem('15d', 'Entrega'),
        ],
      ),
    );
  }
  ...
  Widget _buildTabletVisualSection() {
    return Container(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.circular(20),
        child: Image.asset(
          'assets/onboarding/onboardingPage5.png',
          fit: BoxFit.cover,
  ...
  Widget _buildTabletFeatures() {
    return Column(
      children: [
        _buildTabletFeatureItem(Icons.search_off, 'Productos únicos'),
        const SizedBox(height: 16),
        _buildTabletFeatureItem(Icons.factory, 'Directo de fábrica'),
        const SizedBox(height: 16),
        _buildTabletFeatureItem(Icons.check_circle, 'Calidad garantizada'),
      ],
    );
  }
