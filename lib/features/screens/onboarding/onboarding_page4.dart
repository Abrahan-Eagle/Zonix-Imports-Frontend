...
class _OnboardingPage4State extends State<OnboardingPage4>
              ...
              child: Container(
                decoration: BoxDecoration(
                  image: const DecorationImage(
                    image: AssetImage('assets/onboarding/onboardingPage5.png'),
                    fit: BoxFit.cover,
                  ),
                  gradient: LinearGradient(
                    begin: Alignment.topCenter,
                      ...
                      child: IntrinsicHeight(
                        child: Column(
                          children: [
                            ...
                            _buildSpecialOrderFeatures(isTablet, isSmallPhone),
  ...
  Widget _buildSpecialOrderFeatures(bool isTablet, bool isSmallPhone) {
    return Wrap(
      spacing: isTablet ? 32 : (isSmallPhone ? 24 : 28),
      runSpacing: isTablet ? 24 : (isSmallPhone ? 16 : 20),
      alignment: WrapAlignment.center,
      children: [
        _buildSpecialOrderFeature(
          Icons.search_off,
          'No está',
  ...
  Widget _buildSpecialOrderFeature(IconData icon, String label, Color color,
