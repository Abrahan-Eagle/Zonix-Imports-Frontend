...
class _OnboardingPage3State extends State<OnboardingPage3> {
  ...
  Widget _buildPurchaseOptions() {
    return Row(
      ...
      children: [
        _buildFeatureItem(Icons.shopping_bag, 'Al Detal'),
        _buildFeatureItem(Icons.inventory, 'Al Por Mayor'),
        _buildFeatureItem(Icons.tune, 'Flexible'),
      ],
    );
  }
  ...
  Widget _buildStats() {
    return Container(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceEvenly,
        children: [
          _buildStatItem('1', 'Pieza'),
          _buildStatItem('10+', 'Lote'),
          _buildStatItem('100+', 'Mayorista'),
        ],
      ),
    );
  }
  ...
  Widget _buildTabletVisualSection() {
    return Container(
      ...
      child: ClipRRect(
        borderRadius: BorderRadius.circular(20),
        child: Image.asset(
          'assets/onboarding/onboardingPage4.png',
          fit: BoxFit.cover,
  ...
  Widget _buildTabletFeatures() {
    return Column(
      children: [
        _buildTabletFeatureItem(Icons.shopping_bag, 'Compra individual'),
        const SizedBox(height: 16),
        _buildTabletFeatureItem(Icons.inventory, 'Lotes al por mayor'),
        const SizedBox(height: 16),
        _buildTabletFeatureItem(Icons.tune, 'Precios flexibles'),
      ],
    );
  }
