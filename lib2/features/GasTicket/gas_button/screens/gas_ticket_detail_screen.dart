...
class TicketDetailsScreen extends StatelessWidget {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Text(
                        _formatPhoneNumber(
                            ticket.operatorName, ticket.phoneNumbers),
                        style: TextStyle(
                          fontFamily: 'Plus Jakarta Sans',
                          color: isDarkMode
                              ? Colors.white
  ...
  String _formatPhoneNumber(
      List<String> operatorNames, List<String> phoneNumbers) {
    ...
    // Si tenemos operadores y números, los combinamos correctamente
    List<String> formattedPhones = [];
    for (int i = 0; i < phoneNumbers.length; i++) {
      String operator = i < operatorNames.length ? operatorNames[i] : '';
      String number = phoneNumbers[i];

      if (operator.isNotEmpty) {
        // Formato: "0412 - 4352014" (operador - número completo)
        formattedPhones.add('$operator - $number');
      } else {
        formattedPhones.add(number);
      }
    }
